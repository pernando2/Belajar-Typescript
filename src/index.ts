...
console.log(
  `Biodata: Nama ${biodata[0]}, Umur ${biodata[1]}, Aktif ${biodata[2]}`,
);
console.log(
  `Developer: ${saya.nama}, Stack: ${saya.stack.join(", ")}, Tahun Pengalaman: ${saya.tahunPengalaman}, Aktif: ${saya.aktif}`,
);
console.log(
  `Target stack: ${["TypeScript", "Node.js", "DevOps", "AI Engineering"]}`,
);
